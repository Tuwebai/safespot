...
export function LoginModal({ isOpen, onClose, initialMode = 'login' }: LoginModalProps) {
    ...
    return createPortal(
        <>
            ...
            >
                <div 
                    className="bg-card text-card-foreground w-full max-w-md rounded-t-2xl rounded-b-none sm:rounded-2xl shadow-2xl border-t border-x sm:border border-border overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200 relative pointer-events-auto"
