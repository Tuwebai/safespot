...
export const AdBanner = ({ className = "" }: AdBannerProps) => {
    ...
    return (
        <div className={`ad-wrapper w-full overflow-hidden transition-all duration-300 ${className}`}>
            <div className="bg-card/40 rounded-[2rem] border border-border p-3 md:p-4 min-h-[100px] md:min-h-[150px] flex flex-col items-center justify-center relative group backdrop-blur-md">
