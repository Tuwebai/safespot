            ...
            <Card id="notificaciones" className="bg-dark-card border-dark-border overflow-hidden">
                ...
                <CardContent className="p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {/* Proximidad */}
                        <div className="flex flex-col items-center text-center gap-3 p-4 rounded-xl bg-dark-bg/50 border border-dark-border hover:border-neon-green/30 transition-colors">
