        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {statsDisplay.map((stat, index) => {
              ...
              return (
                <Card key={index} className="bg-dark-card border-dark-border card-glow">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="bg-dark-card border-dark-border card-glow hover:border-neon-green/50 transition-colors">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-foreground/70 leading-relaxed text-center">{feature.description}</p>
                  </CardContent>
                </Card>
              )
            })}
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category, index) => (
              <Card key={index} className="bg-dark-card border-dark-border card-glow hover:border-neon-green/50 transition-colors cursor-pointer">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-neon-green">{category.count}</div>
                  </div>
                </CardContent>
              </Card>
            ))}
